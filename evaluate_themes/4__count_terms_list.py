...
def clean_portrait(portrait: dict[str, str]) -> dict[str, str]:
    """
    The originals may have an "original_clean" key (shouldn't any more though).
    ...
    return {"original": original.lower(), "result": portrait["result"].lower()}
...
# python ./3__count_terms.py --in_dir="../generate_summaries/raw_data" --out_dir="csv_originals"
